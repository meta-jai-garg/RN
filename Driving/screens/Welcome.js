    ...
    renderAwards() {
        return (
            ...
            >
                ...
                <Block middle>
                    <Text spacing={0.4} size={theme.sizes.base} medium white>
                        Wohoo!
                    </Text>
                    <Text spacing={0.4} size={theme.sizes.base} medium white>
                        Safe Driver Trophy!
            ...
            <Card shadow key={trip.id}>
                ...
                <Block row center>
                    <Badge
                        ...
                        style={{ marginRight: 8 }}
                    >
                        <Badge color={theme.colors.accent} size={14} />
                    </Badge>
                ...
                <Block row center>
                    <Badge
                        ...
                        style={{ marginRight: 8 }}
                    >
                        <Badge color={theme.colors.primary} size={14} />
                    </Badge>
                    <Text spacing={0.5} color="gray">
                        {trip.to}
                    </Text>
...
const styles = StyleSheet.create({
    ...
    awards: { padding: theme.sizes.base, marginBottom: theme.sizes.padding },
    moreIcon: {
        width: 16,
        height: 17,
        position: "absolute",
